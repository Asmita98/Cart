...
namespace Cart.Repository
{
    public class CartItemRepo : ICartItemRepo
    {
        ...
        {
            new CartItem{Id=1,UserName ="Test1" , ProductName ="Mobile", Price = 10999, Description ="Lenovo", VendorName ="aaaaaa" , DeliveryDate =DateTime.Parse("12-10-2020"), DeliveryCharge=80 }
